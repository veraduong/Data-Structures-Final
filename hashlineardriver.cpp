...
int main()
{
    ...
    else // if the file opens
    {
        ...
        lp.printTable();
        // lp.searchItem(2);
        // lp.getNumOfCollision();
        // lp.getNumOfCollisionSearch();
    }
    ...
    // for outfile
    ofstream outfileA;
    string filenameA = "insert_search_performance_hash_linear_dataSetA.csv";
    ...
    while(currIndexA < 10000)
    {
        ...
        collisionsInsertA[insColA] = lpA.getNumOfCollision() - prevInsColA;
        prevInsColA = lpA.getNumOfCollision();
        insColA++;
        ...
        collisionsSearchA[searchColA] = lpA.getNumOfCollisionSearch() - prevSearchColA;
        prevSearchColA = lpA.getNumOfCollisionSearch();
        searchColA++;

    } // end while for timing experiment A

    for(int a = 0; a < 100; a++) // cout what is in insert array
    {
        outfileA << insertA[a] << endl;
    }
    for(int a = 0; a < 100; a++) // cout what is in search array
    {
    ...
    // for outfile
    ofstream outfileB;
    string filenameB = "insert_search_performance_hash_linear_dataSetB.csv";
    ...
    while(currIndexB < 10000)
    {
        ...
        collisionsInsertB[insColB] = lpB.getNumOfCollision() - prevInsColB;
        prevInsColB = lpB.getNumOfCollision();
        insColB++;
        ...
        collisionsSearchB[searchColB] = lpB.getNumOfCollisionSearch() - prevSearchColB;
        prevSearchColB = lpB.getNumOfCollisionSearch();
        searchColB++;

    } // end while for timing experiment B

    for(int b = 0; b < 100; b++) // cout what is in insert array
    {
        outfileB << insertB[b] << endl;
    }
    for(int b = 0; b < 100; b++) // cout what is in search array
    {
