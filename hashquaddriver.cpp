...
int main()
{
    /*--------------------------------------- [ TEST IF HASH QUADRATIC PROBING WORKS ] -------------------------------------*/
    // HashQuad hq(7);
    HashQuad hq(40009);
    ...
    else // if the file opens
    {
        ...
        hq.printTable();                       
        // hq.getNumOfCollision();       
        // hq.getNumOfCollisionSearch();         
    }
    ...
    // for outfile
    ofstream outfileA;
    string filenameA = "insert_search_performance_hash_quad_dataSetA.csv";
    ...
    while(currIndexA < 10000)
    {
        ...
        collisionsInsertA[insColA] = hqA.getNumOfCollision() - prevInsColA;
        prevInsColA = hqA.getNumOfCollision();
        insColA++;
        ...
        collisionsSearchA[searchColA] = hqA.getNumOfCollisionSearch() - prevSearchColA;
        prevSearchColA = hqA.getNumOfCollisionSearch();
        searchColA++;

    } // end while for timing experiment A

    for(int a = 0; a < 100; a++) // outfile what is in insert array
    {
        outfileA << insertA[a] << endl;
    }
    for(int a = 0; a < 100; a++) // outfile what is in search array
    {
    ...
    // for outfile
    ofstream outfileB;
    string filenameB = "insert_search_performance_hash_quad_dataSetB.csv";
    ...
    while(currIndexB < 10000)
    {
        ...
        collisionsInsertB[insColB] = hqB.getNumOfCollision() - prevInsColB;
        prevInsColB = hqB.getNumOfCollision();
        insColB++;
        ...
        collisionsSearchB[searchColB] = hqB.getNumOfCollisionSearch() - prevSearchColB;
        prevSearchColB = hqB.getNumOfCollisionSearch();
        searchColB++;

    } // end while for timing experiment B

    for(int b = 0; b < 100; b++) // outfile what is in insert array
    {
        outfileB << insertB[b] << endl;
    }
    for(int b = 0; b < 100; b++) // outfile what is in search array
    {
